<div class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
        ...
        <div class="app-sidebar__user"><img class="app-sidebar__user-avatar"
                src="https://s3.amazonaws.com/uifaces/faces/twitter/jsa/48.jpg" alt="Sem imagem">
            <div>
                <p class="app-sidebar__user-name">John Doe</p>
            </div>
        </div>
        <ul class="app-menu">
            <li><a class="app-menu__item active" href="dashboard.html"><i
            ...
            <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a class="treeview-item" href="page-user.html"><i class="icon fa fa-circle-o"></i> User
                            Page</a></li>
